    ...
    >
      <div className="content-container">
        <div className="w-full flex flex-row gap-2 items-center justify-between">
          <TextInput name="name" required={true} label="Name" error={!!inputErrors.name} defaultValue={data.name} />

          <TextInput
            label="User"
            name="user-id"
            disabled={true}
            defaultValue={data.userIds ? (typeof data.userIds[0] === "string" ? data.userIds[0] : data.userIds[0]._id) : undefined}
          />
        </div>
